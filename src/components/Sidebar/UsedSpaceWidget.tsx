  ...
  return (
    <div className="flex flex-col gap-4 rounded-lg bg-violet-50 px-4 py-5 dark:bg-zinc-800">
      <div className="space-y-1">
        ...
        <p className="text-sm font-medium text-violet-500 dark:text-zinc-400">
          Your team has used 80% of your available space. Need more?
        </p>
      </div>

      <div className="h-2 rounded-full bg-slate-100 dark:bg-zinc-600">
        <div className="h-2 w-4/5 bg-violet-600 dark:bg-violet-400" />
      </div>
