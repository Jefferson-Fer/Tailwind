  ...
  variants: {
    state: {
      ...
      error: {
        ...
        icon: 'border-red-50 text-red-600 bg-red-100 dark:bg-red-500/5 dark:border-red-500/30 dark:text-red-400',
        deleteButton:
...
const FileItem = ({ name, size, state }: FileItemProps) => {
  ...
  return (
    <div className={container()}>
      ...
      {state === 'complete' ? (
        <CheckCircle2 className="h05 w-5 fill-violet-600 text-white" />
      ) : (
